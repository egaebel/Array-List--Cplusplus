...
class ArrayList {
    ...
    private:
         ...
         * which is the best pivot. Then places the pivot in the second to last
         * slot of the array, to go along with quickSort logic. This ensures that the pivot
         * will always be the center element.
         *
         * Runs in O(1) time.
         *
         ...
         */
        T choosePivot(int index1, int index2) {
         ...
         */
        int binarySearch(T element, int index1, int index2) {
    ...
    public:
         ...
         * @return removed the removed element, or NULL/0 if
         ...
         * @return the element stored at index, or NULL if the index isn't valid.
         */
        ...
        ArrayList<T> subList(int index1, int index2) {

            if (index1 >= 0 && index1 < size && index2 >= 0 && index2 <= size && index1 < index2) {

                ArrayList<T> returnList = ArrayList<T>(index2 - index1);
        ...
        T* getSubArray(int index1, int index2) {
         ...
         * Recursive.
         *
         * Runs in O(nlog(base 2)n) in all cases because the pivot point will never be the lowest element all the time
         * due to the choosePivot method's functioning.
         *
        ...
        void quickSort(int index1, int index2) {
            ...
            if (index2 - index1 >= 10) {
                ...
                T pivot = choosePivot(index1, index2);
